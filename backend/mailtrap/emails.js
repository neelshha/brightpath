...
export const sendWelcomeEmail = async(email, name) => {
    ...
    try {
        const response = await mailtrapClient.send({
            from: sender,
            to: recipient,
            template_uuid: "9c7b8d55-70c0-4c2e-9ccf-a2a8b5a5632a",
            template_variables: {
                "company_info_name": "Bright Path",
                "name": name,
                "company_info_city": "Mumbai",
                "company_info_zip_code": "400 058",
...
export const sendResetSuccessEmail = async (email) => {
    ...
    try {
        ...
        throw new Error("Error in password reset process: ${error}");
    }
}